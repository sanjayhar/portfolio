          ...
          <div className="max-w-4xl mx-auto px-6 mb-16">
            <div className="reveal grid grid-cols-2 md:grid-cols-4 gap-4">
              {caseStudy.stats.map((stat) => (
                <div
                  key={stat.label}
                  className="stat-card bg-white/40 dark:bg-zinc-900/30 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-800/40 rounded-2xl p-5 pl-6 shadow-sm"
                >
                  <p
          ...
          <div className="max-w-5xl mx-auto px-6 mb-12">
            <div className="reveal grid md:grid-cols-3 gap-5">
              {caseStudy.principles.map((principle) => (
                <div
                  key={principle.title}
                  className="bg-white/40 dark:bg-zinc-900/30 backdrop-blur-md rounded-2xl p-7 border border-zinc-200/50 dark:border-zinc-800/40 hover:border-accent/60 transition-all duration-300 shadow-sm"
                >
                  <div className="w-10 h-10 bg-orange-50/80 dark:bg-zinc-800/60 rounded-xl flex items-center justify-center mb-4">
          ...
          <div className="max-w-4xl mx-auto px-6 mb-12">
            <div className="reveal space-y-4">
              {caseStudy.steps.map((step, index) => (
                <div
                  key={step.title}
                  className="flex gap-5 bg-white/40 dark:bg-zinc-900/30 backdrop-blur-md rounded-2xl p-6 border border-zinc-200/50 dark:border-zinc-800/40 hover:border-accent/60 transition-all duration-300 shadow-sm"
                >
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {caseStudy.relatedProjects.map((project) => (
                <article
                  key={project.title}
                  className="reveal card-h group bg-white/40 dark:bg-zinc-900/30 backdrop-blur-md rounded-2xl overflow-hidden border border-zinc-200/50 dark:border-zinc-800/40 hover:border-accent hover:shadow-[0_0_40px_rgba(255,107,43,0.12)] transition-all duration-300"
                >
                  <PhotoFrame
                    src={project.image}
                    alt={project.title}
