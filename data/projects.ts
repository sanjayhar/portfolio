...
export const projects: Project[] = [
  {
    ...
    featuredDescription:
      "A production-ready SaaS platform developed for finance collection companies to manage branches, employees, customer records, collections, analytics, reporting, and operational workflows through a centralized dashboard.\n\nKey features include role-based access control, branch management, employee management, customer tracking, collection tracking, and bulk Excel upload for fast data onboarding.\n\nThe platform also includes an analytics dashboard, detailed reports, performance monitoring, and cloud deployment for reliability, scalability, and security.",
  ...
  },
  {
    ...
    featuredDescription:
      "Designed and developed a professional business website for an advocate with a focus on credibility, user experience, SEO, responsive design, and online client engagement.\n\nThe project included UI/UX design, responsive layouts, search engine optimization, cloud deployment, domain configuration, and performance optimization to create a fast, modern, and trustworthy online presence.",
  ...
  },
  {
    ...
    featuredDescription:
      "Designed cloud infrastructure and deployment pipelines using AWS services with Infrastructure as Code principles, containerization, CI/CD automation, and cloud monitoring.\n\nThe infrastructure leverages EC2, S3, IAM, VPC, Route53, and CloudWatch, while Terraform manages infrastructure provisioning and GitHub Actions automates CI/CD workflows with Docker-based deployments.",
