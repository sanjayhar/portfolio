...
export function Work() {
  ...
  return (
    <section ref={sectionRef} id="work" className="py-24 relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {featured && (
            <div ref={featuredRef} className="md:row-span-2">
              <TiltCard className="h-full">
                <article className="card-h group rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 hover:border-accent hover:shadow-[0_0_40px_rgba(255,107,43,0.12)] transition-all duration-300 h-full">
          ...
          {others.map((project, i) => (
            <div key={project.id} ref={(el) => { othersRef.current[i] = el; }}>
              <TiltCard className="h-full">
                <article className="card-h group rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 hover:border-accent hover:shadow-[0_0_30px_rgba(255,107,43,0.1)] transition-all duration-300 h-full">
