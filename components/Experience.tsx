            ...
            {experience.timeline.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* card */}
                  <div className={`glass rounded-2xl p-6 border card-h transition-all duration-300 ${
                    isCurrent
                      ? "border-accent/30 hover:border-accent shadow-[0_0_24px_rgba(255,107,43,0.08)]"
                      : "border-zinc-100 dark:border-zinc-800 hover:border-accent"
                  }`}>
